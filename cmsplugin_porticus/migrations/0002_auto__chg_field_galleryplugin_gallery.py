...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GalleryPlugin.gallery'
        db.alter_column(u'cmsplugin_galleryplugin', 'gallery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['porticus.Gallery']))

    def backwards(self, orm):

        # Changing field 'GalleryPlugin.gallery'
        db.alter_column(u'cmsplugin_galleryplugin', 'gallery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['porticus.Album']))
